    ...
    <section id="work" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-8 sm:space-y-12">
          {[
            {
              title: "Real-time Dashboard PoS",
              description: "Real-time point of sale (POS) system built with cutting-edge web technologies",
              metrics: {
                performance: 98,
                accessibility: 100,
                seo: 100,
            ...
            },
            {
              ...
              description: "Hospital Executive Management Information System",
              metrics: {
                performance: 95,
                accessibility: 98,
                seo: 100,
